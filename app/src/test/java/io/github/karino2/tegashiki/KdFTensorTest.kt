...
class KdFTensorTest {
    ...
    fun createStrokeTensor() : KdFTensor {
        val res = KdFTensor(Model.MAX_STROKE_NUM*Model.MAX_ONE_STROKE_LEN*Model.INPUT_DIM).reshape(Model.MAX_STROKE_NUM, Model.MAX_ONE_STROKE_LEN, Model.INPUT_DIM)
